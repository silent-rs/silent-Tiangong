...
//!   sync_config / load_session 等管理性操作，**不执行 turn**
//! - **CoreFactory**：host（桌面 / 服务端 / CLI）注入的构造策略——插件构造差异大，
//!   不能在共享层硬编码
...
pub use core_manager::{CoreManager, CoreRegistry, CoreRegistryGuard};
pub use factory::{CoreFactory, EnsuredCore};
