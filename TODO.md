...
- [x] 从最新主分支创建 `release/0.7.0` worktree
- [x] 更新 `Cargo.toml` 版本号为 `0.7.0`
- [x] 更新 `frontend/package.json` 版本号为 `0.7.0`
- [x] 更新 `tauri.conf.json` 版本号为 `0.7.0`
- [x] 更新发布流水线默认标签、Release 标题和 OSS 上传默认标签为 `v0.7.0`
- [x] 运行 Rust 检查
- [x] 运行 Rust lint
- [x] 运行 Rust 测试
- [x] 运行前端构建
