...
- [x] 从最新主分支创建 `release/0.5.0` worktree
- [x] 更新 `Cargo.toml` 版本号为 `0.5.0`
- [x] 更新 `frontend/package.json` 版本号为 `0.5.0`
- [x] 更新 `tauri.conf.json` 版本号为 `0.5.0`
- [x] 更新发布流水线默认标签和 Release 标题为 `v0.5.0`
- [x] 运行 Rust 检查
- [x] 运行前端构建
- [x] 创建发布提交与 `v0.5.0` 标签
