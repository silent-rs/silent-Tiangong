...
- [x] 从最新主分支创建 `release/0.10.1` worktree
- [x] 更新 `Cargo.toml` 版本号为 `0.10.1`
- [x] 更新 `frontend/package.json` 版本号为 `0.10.1`
- [x] 更新 `tauri.conf.json` 版本号为 `0.10.1`
- [x] 更新发布流水线默认标签、Release 标题和 OSS 上传默认标签为 `v0.10.1`
- [x] 运行 Rust 检查（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 运行 Rust lint（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 运行前端构建（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 合并发布分支到 `main`
- [x] 在 `main` 最终发布提交创建并推送 `v0.10.1` 标签

## 发布准备（0.10.2）

- [x] 从最新主分支创建 `release/0.10.2` worktree
- [x] 更新 `Cargo.toml` 版本号为 `0.10.2`
- [x] 更新 `frontend/package.json` 版本号为 `0.10.2`
- [x] 更新 `tauri.conf.json` 版本号为 `0.10.2`
- [x] 更新发布流水线默认标签、Release 标题和 OSS 上传默认标签为 `v0.10.2`
- [x] 运行 Rust 检查（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 运行 Rust lint（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 运行前端构建（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 合并发布分支到 `main`
- [x] 在 `main` 最终发布提交创建并推送 `v0.10.2` 标签

## 发布准备（0.11.0）

- [x] 从最新主分支创建 `release/0.11.0` worktree
- [x] 更新 `Cargo.toml` 版本号为 `0.11.0`
- [x] 更新 `frontend/package.json` 版本号为 `0.11.0`
- [x] 更新 `tauri.conf.json` 版本号为 `0.11.0`
- [x] 更新发布流水线默认标签、Release 标题和 OSS 上传默认标签为 `v0.11.0`
- [x] 运行 Rust 检查（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 运行 Rust lint（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 运行前端构建（跳过本地验证，交由 CI 在标签推送后执行）
- [x] 合并发布分支到 `main`
- [x] 在 `main` 最终发布提交创建并推送 `v0.11.0` 标签
