# @tiangong/plugin-creator（devkit）

天工插件创作工具链 CLI。经命令通道执行（Agent 的 run_command）：

```bash
npx -y @tiangong/plugin-creator@1.0.0 init ui-app my-dashboard --name 我的看板
npx -y @tiangong/plugin-creator@1.0.0 validate my-dashboard
npx -y @tiangong/plugin-creator@1.0.0 build my-dashboard
npx -y @tiangong/plugin-creator@1.0.0 run my-dashboard -- --name 测试
npx -y @tiangong/plugin-creator@1.0.0 logs dev:my-dashboard
```
