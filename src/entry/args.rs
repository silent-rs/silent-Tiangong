...
pub(super) struct MainArgs {
    #[command(subcommand)]
    pub(super) command: Option<MainCommand>,
}

#[derive(Debug, Subcommand)]
#[allow(clippy::large_enum_variant)]
pub(super) enum MainCommand {
...
pub(super) struct SkillArgs {
    #[command(subcommand)]
    pub(super) command: SkillSubcommand,
}

#[derive(Debug, Clone, Copy, ValueEnum)]
pub(super) enum McpTransportArg {
    Auto,
    Stdio,
    Http,
}
...
#[derive(Debug, Subcommand)]
#[allow(clippy::large_enum_variant)]
pub(super) enum SkillSubcommand {
...
pub(super) fn parse_key_value(raw: &str) -> Result<(String, String), String> {
    let (key, value) = raw
        .split_once('=')
