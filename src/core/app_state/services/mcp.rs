...
pub(in crate::core::app_state) struct AppMcpService;

impl AppMcpService {
    pub(in crate::core::app_state) fn register_mcp_server(
        self,
    ...
    pub(in crate::core::app_state) fn remove_mcp_server(
        self,
        state: &mut TiangongState,
        name: &str,
    ) -> Result<String> {
    ...
    pub(in crate::core::app_state) fn set_mcp_server_enabled(
        self,
        state: &mut TiangongState,
        name: &str,
        enabled: bool,
    ...
    pub(in crate::core::app_state) fn update_agent_config_entry(
        self,
        state: &mut TiangongState,
        key: &str,
        value: &str,
