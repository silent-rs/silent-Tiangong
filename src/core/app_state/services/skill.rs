...
pub(in crate::core::app_state) struct AppSkillService;

impl AppSkillService {
    pub(in crate::core::app_state) fn init_skill_scaffold(
        self,
        path: &str,
        name: Option<&str>,
        id: Option<&str>,
    ...
    pub(in crate::core::app_state) fn inspect_skill_install_requirements(
        self,
        state: &TiangongState,
        path: &str,
    ...
    pub(in crate::core::app_state) fn install_local_skill_with_options_and_inputs(
        self,
    ...
    pub(in crate::core::app_state) fn remove_skill(
        self,
        state: &mut TiangongState,
        id: &str,
    ) -> Result<String> {
    ...
    pub(in crate::core::app_state) fn set_skill_enabled(
        self,
        state: &mut TiangongState,
        id: &str,
        enabled: bool,
