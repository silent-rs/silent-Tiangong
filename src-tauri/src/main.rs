...
fn run_gui() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tiangong_app::commands::snapshot_list,
            tiangong_app::commands::snapshot_changeset,
            tiangong_app::commands::snapshot_restore,
            tiangong_app::commands::snapshot_restore_file,
            tiangong_app::commands::plugin_trust_list,
