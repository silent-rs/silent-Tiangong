...
- P1：开发 Coding 专用 WASM 插件，以提示词编排现有文件、检索、命令和终端能力，并通过 sidecar 补充项目上下文与流程状态能力。
